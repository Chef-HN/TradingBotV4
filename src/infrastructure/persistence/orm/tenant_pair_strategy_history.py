...
from sqlalchemy import BigInteger, Boolean, DateTime, Integer, Numeric, String, Text, Uuid
from sqlalchemy.orm import Mapped, mapped_column

from .base import Base


class TenantPairStrategyHistoryRow(Base):
    __tablename__ = "tenant_pair_strategy_history"
